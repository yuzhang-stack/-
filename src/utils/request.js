...
import resetToken from '@/store/modules/user'
import {getToken, removeToken} from '@/utils/auth'

// create an axios instance
const service = axios.create({
  baseURL: 'https://yifangweb.insightin.cn', // url = base url + request url
  // baseURL: 'http://172.16.0.160:8099', // url = base url + request url
...
service.interceptors.response.use(
  /**
   * If you want to get http information such as headers or status如果您想要获得http信息，例如头或状态
   * Please return  response => response请返回响应=>响应
   */
...
// export default { service , serviceNew }
